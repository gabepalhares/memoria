  ...
  return (
    <>
      ...
      <footer className="p-6 text-center text-white/80 sm:p-12">
        <strong>Love</strong> is the one thing we're capable of perceiving that transcends dimensions of <strong>time</strong> and <strong>space.</strong> - Brand, Interstellar.
      </footer>
    </>
  );
};
